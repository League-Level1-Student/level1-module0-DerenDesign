...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		int G = getTotalDistance();
		//4. Call the hasCrossedFinishLine() method and save what is returned into a variable
		boolean C = hasCrossedFinishLine();
		//5. If the robot has crossed the finish line... 
		if (C) {
			JOptionPane.showMessageDialog(null, "The robot finished! It went " + G);
		}
		else {
			JOptionPane.showMessageDialog(null, "The robot did not finish :( It went " + G);
		}
